%{
Map 2: Christmas terrain with 3 threat cylinders
- Sparse threat layout for baseline comparison
%}

function model = CreateModel_map2()
    ...
    % Threats as cylinders (3 threats)
    R1=80;  % Radius
