...
%  ICPO v2 Batch: 20-run comparison vs ICPO v1                             %
%_________________________________________________________________________%
...
[p,h]=ranksum(results.ICPOv1.finalCosts, results.ICPOv2.finalCosts);
fprintf('Wilcoxon p=%.6f (p<0.05 = significant)\n', p);

save('results/ICPOv2_comparison.mat','results','algs','N_RUNS');
disp('Saved to results/ICPOv2_comparison.mat');
